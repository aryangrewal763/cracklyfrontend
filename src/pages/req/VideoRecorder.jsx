            ...
            {videos.map((video) => (
              <div key={video.filename} className="bg-white p-3 rounded-lg shadow">
                <div className="relative" style={{ paddingBottom: '56.25%' }}>
                  ...
                  >
                    <source src={`https://cracklybackend.onrender.com/uploads/video/${video.filename}`} type="video/webm" />
                ...
                <div className="mt-2">
                  ...
                  <div className="flex justify-between items-center mt-1">
                    ...
                    <a
                      href={`https://cracklybackend.onrender.com/uploads/video/${video.filename}`}
